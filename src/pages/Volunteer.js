...
import { services, classes, equipment, spaces, volunteerList } from '../components/serviceList';
                ...
                <div className="service">
                    ...
                    <div className="service__component">
                        ...
                        <div className="service__component-descr">
                            Volunteers are vital to our services and our community. We are always looking for
                            more volunteers to help out with the community services.  Click on each service to see more information
                            and where you may be able to volunteer.
                        </div>
                        <div className="service__component-list">
                            Volunteer to help with services (may require skill assessment):
                            {services.map((service) => (
                            <div key={service.id}>
                                <a href="/volunteer-item-info"
